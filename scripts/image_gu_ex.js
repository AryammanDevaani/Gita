...
(async () => {
    const data = JSON.parse(fs.readFileSync('content_data_gu.json', 'utf8'));
    ...
    const htmlTemplate = `
        ...
        <head>
        <style>
            @font-face { font-family: 'GujaratiFont'; src: url('https://gītā.bhgvd.com/fonts/fontgujarati.ttf'); }
    ...
    await page.screenshot({ path: 'image_gu_ex.png', type: 'jpeg', quality: 100 });
    await browser.close();
    console.log("Gujarati Explanation Rendered.");
})();
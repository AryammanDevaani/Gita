...
with open('content_data_gu.json', 'r') as f:
    data = json.load(f)

IMG_URL = f"https://raw.githubusercontent.com/aryammandevaani/gita/main/image_gu.png?t={int(time.time())}"
TEXT = data.get('caption')

def publish():
    print(f"🚀 Pinging Instagram (Gujarati) for image: {IMG_URL}")
    ...
    print("🎉 SUCCESS: Gujarati Post is live!")
